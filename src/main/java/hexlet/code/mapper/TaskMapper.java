...
public abstract class TaskMapper {
    ...
    protected TaskStatus slugToTaskStatusNullable(
        ...
        if (slugNullable == null || !slugNullable.isPresent()) return null;
    ...
    protected User idToUserNullable(
        ...
        if (idNullable == null || !idNullable.isPresent()) return null;
    ...
    protected Set<Label> idsToLabelsNullable(
        ...
        if (idsNullable == null || !idsNullable.isPresent()) return null;
